...
#   Q1        : 游戏 上传  SP  EF  (sch0, 109.x UDP<=300B)
#   Q2-Q30    : smarthqos 上传 WRR AF41 (sch2)
#   Q31       : 限速设备 上传 WRR BE  (sch2, 所有共享)
#   Q32       : VIP 下载  SP  EF  (sch1)
#   Q33       : 游戏 下载  SP  EF  (sch1, 109.x UDP<=300B)
#   Q34-Q62   : smarthqos 下载 WRR AF41 (sch3)
#   Q63       : 限速设备 下载 WRR BE  (sch3, 所有共享)
